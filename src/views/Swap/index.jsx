...
import './Swap.scss'
import SwapSelection from '../../modals/SwapSelection'
...
export default function Swap() {
    ...
    return (
        <div className="swap">
            <SwapSelection handleClose={handleClose} show={show}/>
                            ...
                            <div className="swap-content w-100">
                                <div className="swap-block">
                                    <div className="d-flex align-items-center justify-content-between pb-3">
                                        ...
                                        <div onClick={() => handleShow()} className="swap-block-select d-flex align-items-center">
                                ...
                                <div className="swap-block">
                                    <div onClick={() => handleShow()} className="d-flex align-items-center justify-content-between pb-3">
                                        <div className="swap-block-text">
                                            To
                                        </div>
